...
package reg_defines_secret_flow;
...
sub DEVICE_PROJ_DIR ()  { "secret_flow"; }
sub DEVICE_PROJ_NAME () { "Secret Flow"; }
sub DEVICE_PROJ_DESC () { "Secret Flow Switch"; }
...
sub SECRET_FLOW_BASE_ADDR ()     { 0x2000000; }
...
sub SECRET_FLOW_KEY_REG ()   { 0x2000000;}
